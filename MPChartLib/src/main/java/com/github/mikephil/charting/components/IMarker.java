...
public interface IMarker {
     ...
     *                  isShowLine = true this is show line Data。if not do
     */
    void refreshContent(Entry[] e, Highlight highlight ,boolean isShowLine);
    ...
    /**
     Calculating the total width of a control.
     */
    int getTotalWidth();
}

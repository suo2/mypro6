...
/**
 * Create Date: 2015-4-27<br>
 * Create Author: cWX239309<br>
 * Description : 带方格的坐标控件
 */
public class GridBaseView extends BaseCoordinate
{
...
//                (int) maxTextPxSize + Utils.dp2Px(getContext(), mTextMargin), (int) mPointLength);
        ...
        for (int i = 0; i < mPointLength; i = i + increaseSize)
        {
            ...
            onDrawYValue(canvas, i, mCoordinateAdapter.getColor(i, mPointLength));
        }
    }
